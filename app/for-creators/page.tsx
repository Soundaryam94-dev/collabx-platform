...
import { Handshake, Briefcase, BarChart2, Bell, CheckCircle, ArrowRight, Zap, Star, TrendingUp } from "lucide-react";
...
const features = [
  ...
  },
  {
    ...
    desc: "Accept or decline brand invites in one click. Chat directly with brands and manage everything in one place.",
  },
  {
    icon: BarChart2,
    color: "#6366F1",
    title: "Track Your Growth",
    desc: "See your reach, engagement, and collaboration history across all brand partnerships in one dashboard.",
  },
  {
    icon: Bell,
    color: "#8B5CF6",
...
const steps = [
  ...
  { step: "04", title: "Build long-term partnerships", desc: "Grow your brand relationships, get featured on more campaigns, and expand your creator portfolio." },
];

const stats = [
  { value: "500+", label: "Active Brands" },
  { value: "158+", label: "Verified Creators" },
    ...
    <div className="min-h-screen">
        ...
        <div className="max-w-4xl mx-auto text-center">
          <motion.div initial={{ opacity: 0, y: 24 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.5 }}>
            ...
            <h1 className="text-4xl md:text-6xl font-extrabold text-white mb-6 leading-tight">
              Turn Your Audience into <span className="gradient-text">Real Partnerships</span>
            </h1>
            <p className="text-[#A1A1AA] text-lg mb-10 max-w-2xl mx-auto">
              Connect with top brands, manage your collaborations, and grow your influence — all from one simple dashboard built for creators.
            </p>
      ...
      <section className="px-4 pb-20">
        <div className="max-w-5xl mx-auto">
          <div className="text-center mb-12">
            <h2 className="text-3xl font-extrabold text-white mb-3">Everything you need to grow with brands</h2>
            <p className="text-[#A1A1AA]">From brand discovery to collaboration, CollabX makes it effortless.</p>
          </div>
      ...
      <section className="px-4 pb-20">
        <div className="max-w-4xl mx-auto">
          <div className="text-center mb-12">
            ...
            <p className="text-[#A1A1AA]">Start collaborating with top brands in minutes.</p>
          </div>
      ...
      <section className="px-4 pb-24">
        <div className="max-w-2xl mx-auto text-center glass rounded-3xl p-12 border border-[#A855F7]/20">
          ...
          <h2 className="text-3xl font-extrabold text-white mb-3">Start collaborating with your audience</h2>
